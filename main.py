...
from util import nvidia_prefetcher

from models.lstm_cross_cycle_gcn_dropout import LSTMCrossCycleGCNDropout
...
if __name__ == '__main__':
    ...
    parser.add_argument('--q_max_length', type=int, default=35)
    parser.add_argument('--v_max_length', type=int, default=80)

    parser.add_argument(
        '--model', type=int, default=7, help='see models training')
    parser.add_argument(
        '--task',
        type=str,
        default='Count',
    ...
    parser.add_argument(
        '--server', type=str, default='1080ti', help='780, 1080ti, 1080')
    parser.add_argument(
